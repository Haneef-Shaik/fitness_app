...
| 20 | L-02 | An item that failed on auth says "Log back in to carry on" **while signed in** (it failed during an earlier sign-out) | Low | **dated 2026-10-31** — the message is stale, not wrong; Try again works |
